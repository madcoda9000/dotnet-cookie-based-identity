    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress"> \
                  <div class="progress-bar progress-bar-striped countdown-bar active bg-danger" role="progressbar" style="min-width: 15px; width: 100%;"> \
                    <span class="countdown-holder"></span> \
                  </div> \
                </div>' : '';

            $('Body').append('<div class="modal fade text-left" id="session-timeout-dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true"> \
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document"> \
                    <div class="modal-content"> \
                        <div class="modal-header bg-danger"> \
                            <h5 class="modal-title white" id="myModalLabel120" style="color:#fff !important">' + opt.title + '</h5> \
                        ...
                        <div class="modal-footer"> \
                            ...
                            <button id="session-timeout-dialog-keepalive" type="button" class="btn btn-danger" data-bs-dismiss="modal">' + opt.keepAliveButton + '</button> \
                        </div> \
                    </div> \
                </div> \
            ');
